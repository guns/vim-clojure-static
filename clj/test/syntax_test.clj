...
(def regexp-char-class  (all :clojureRegexpCharClass))
(def !regexp-char-class (complement regexp-char-class))
(def regexp-predefined-char-class  (all :clojureRegexpPredefinedCharClass))
(def !regexp-predefined-char-class (complement regexp-predefined-char-class))
(def regexp-posix-char-class  (all :clojureRegexpPosixCharClass))
(def !regexp-posix-char-class (complement regexp-posix-char-class))
(def regexp-boundary  (all :clojureRegexpBoundary))
(def !regexp-boundary (complement regexp-boundary))
(def regexp-quantifier  (all :clojureRegexpQuantifier))
(def !regexp-quantifier (complement regexp-quantifier))
(def regexp-back-ref  (all :clojureRegexpBackRef))
(def !regexp-back-ref (complement regexp-back-ref))
(def regexp-quote  (all :clojureRegexpQuote))
(def !regexp-quote (complement regexp-quote))
(def regexp-or  (all :clojureRegexpOr))
(def !regexp-or (complement regexp-or))
(def regexp-group  (all :clojureRegexpGroup))
