...
syntax keyword clojureCond case clojure.core/case clojure.core/cond clojure.core/condp clojure.core/if-let clojure.core/if-not clojure.core/when clojure.core/when-first clojure.core/when-let clojure.core/when-not cond condp if-let if-not when when-> when->> when-first when-let when-not
