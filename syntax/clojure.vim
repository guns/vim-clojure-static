...
syntax match clojureRegexpEscape "\v\\%(\\|[tnrfae]|c\u|0[0-3]?\o{1,2}|x%(\x{2}|\{\x{1,9}\})|u\x{4}|.)" contained
...
syntax match clojureRegexpPosixCharClass "\v\\[pP]\{%(Alnum|Alpha|ASCII|Blank|Cntrl|Digit|Graph|Lower|Print|Punct|Space|Upper|XDigit)\}" contained
...
syntax match clojureRegexpUnicodeCharClass "\v\\[pP]\{%(Is)?%(C[cfnos]|L[lmotu]|M[cen]|N[dlo]|P[cdefios]|S[ckmo]|Z[lps])\}" contained
syntax match clojureRegexpUnicodeCharClass "\v\\[pP]%(C|L|M|N|P|S|Z)" contained
