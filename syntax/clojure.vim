...
syntax keyword clojureCond case clojure.core/case clojure.core/cond clojure.core/condp clojure.core/if-let clojure.core/if-not clojure.core/when clojure.core/when-> clojure.core/when->> clojure.core/when-first clojure.core/when-let clojure.core/when-not cond condp if if-let if-not when when-> when->> when-first when-let when-not
...
syntax keyword clojureMacro -> ->> .. amap and areduce assert binding bound-fn clojure.core/-> clojure.core/->> clojure.core/.. clojure.core/amap clojure.core/and clojure.core/areduce clojure.core/assert clojure.core/binding clojure.core/bound-fn clojure.core/comment clojure.core/declare clojure.core/delay clojure.core/dosync clojure.core/doto clojure.core/extend-protocol clojure.core/extend-type clojure.core/future clojure.core/gen-class clojure.core/gen-interface clojure.core/import clojure.core/io! clojure.core/lazy-cat clojure.core/lazy-seq clojure.core/let-> clojure.core/letfn clojure.core/locking clojure.core/memfn clojure.core/ns clojure.core/or clojure.core/proxy clojure.core/proxy-super clojure.core/pvalues clojure.core/refer-clojure clojure.core/reify clojure.core/sync clojure.core/test-> clojure.core/test->> clojure.core/time clojure.core/with-bindings clojure.core/with-in-str clojure.core/with-loading-context clojure.core/with-local-vars clojure.core/with-open clojure.core/with-out-str clojure.core/with-precision clojure.core/with-redefs comment declare delay dosync doto extend-protocol extend-type future gen-class gen-interface import io! lazy-cat lazy-seq let-> letfn locking memfn ns or proxy proxy-super pvalues refer-clojure reify sync test-> test->> time with-bindings with-in-str with-loading-context with-local-vars with-open with-out-str with-precision with-redefs
