...
let s:clojure_syntax_keywords = {
    ...
    \ , 'clojureSpecial': [".","catch","clojure.core/fn","clojure.core/let","clojure.core/loop","def","do","finally","fn","if","let","loop","monitor-enter","monitor-exit","new","quote","recur","set!","throw","try","var"]
